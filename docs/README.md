...
- [ui-agent-prompt.md](ui-agent-prompt.md): stack-agnostic prompt for generating a frontend against this backend
...
6. Point the generated frontend to the backend API URL.
